      ...
      <address className="contact__info">
        ...
        <div>
          ...
          <ul>
            <li>
              - Email: {""}
              <a href="mailto:support@pizzabyte.com" target="_blank" rel="noopener noreferrer">
                support@pizzabyte.com
              </a>
            </li>
            <li>
              - <a href="tel:880255155097">Phone: +880-2-55155097</a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              - Email: {""}
              <a href="mailto:info@pizzabyte.com" target="_blank" rel="noopener noreferrer">
                info@pizzabyte.com
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul>
            <li>
              - Email: {""}
              <a href="mailto:feedback@pizzabyte.com" target="_blank" rel="noopener noreferrer">
                feedback@pizzabyte.com
              </a>
            </li>
          </ul>
        </div>
